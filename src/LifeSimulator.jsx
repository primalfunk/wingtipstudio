...
const LifeSimulator = () => {
    ...
    const [atomCount, setAtomCount] = useState(500);
  ...
  }, [dimensions, atomCount, gravityBB, gravityBR, gravityBC, gravityRR, gravityRB, gravityRC, gravityCC, gravityCR, gravityCB, gravityGG, gravityGB, gravityGR, gravityGC]);
  ...
  return (
    <div className="page-container">
        ...
        <div className="atomcount">
                ...
                <label>
                  <p className="gravity-exp">Gravity sliders go from max attraction (left) to max repelling force (right)</p>
                </label>
            </div>
